...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public void onUpdate() {
		if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
			...
			if (this.isRiding()) {
				...
				BaseClient.instance.getEventManager().call(new PreMotionEvent(this.posX, this.posY, this.posZ,
	...
	public void sendChatMessage(String message) {
		MessageSentEvent messageSentEvent = (MessageSentEvent) BaseClient.instance.getEventManager()
				.call(new MessageSentEvent(message));
